            ...
            <div class="b">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td><font color="red">SE1645</font></td>
                            <td><font color="red">HE163829</font></td>
                            <td>Pham Cong Chi</td>
                        ...
                        <tr>
                            <td>2</td>
                            <td><font color="red">SE1645</font></td>
                            <td><font color="red">HE163456</font></td>
                        ...
                        <tr>
                            <td>3</td>
                            <td><font color="red">SE1645</font></td>
                            <td><font color="red">HE161999</font></td>
                            <td>Tran Van A</td>
                            <td><input type="radio" name="present" value="absent"/> Absent</td>
                            <td><input type="radio" name="present" value="present"/> Present </td>
                            ...
                            <td>4</td>
                            <td><font color="red">SE1645</font></td>
                            <td><font color="red">HE161111</font></td>
                            <td>Tran Van B</td>
                            <td><input type="radio" name="present" value="absent"/> Absent</td>
                            <td><input type="radio" name="present" value="present"/> Present </td>
                            ...
                            <td>5</td>
                            <td><font color="red">SE1645</font></td>
                            <td><font color="red">HE162313</font></td>
                            <td>Nguyen Van C</td>
                            <td><input type="radio" name="present" value="absent"/> Absent</td>
                            <td><input type="radio" name="present" value="present"/> Present </td>
                            ...
                            <td>6</td>
                            <td><font color="red">SE1645</font></td>
                            <td><font color="red">HE162222</font></td>
                            <td>Nguyen Van D</td>
                            <td><input type="radio" name="present" value="absent"/> Absent</td>
                            <td><input type="radio" name="present" value="present"/> Present </td>
                            ...
                            <td>7</td>
                            <td><font color="red">SE1645</font></td>
                            <td><font color="red">HE161000</font></td>
                            <td>Chu Huu Thanh</td>
                            <td><input type="radio" name="present" value="absent"/> Absent</td>
                            <td><input type="radio" name="present" value="present"/> Present </td>
                            ...
                            <td>8</td>
                            <td><font color="red">SE1645</font></td>
                            <td><font color="red">HE160000</font></td>
                            <td>Pham Linh Chi</td>
                            <td><input type="radio" name="present" value="absent"/> Absent</td>
                            <td><input type="radio" name="present" value="present"/> Present </td>
